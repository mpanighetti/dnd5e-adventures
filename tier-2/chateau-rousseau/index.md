...
In either case, all the spirits trapped inside the house, including the other Rousseau children, are freed to move on from this pocket dimension. However, if the front door is opened without stopping Goren, he too is released from his prison, and leaves to unknown realms to pursue his hunger.

## Suggested house rules

Player death is always a possibility in Dungeons & Dragons, but Chateau Rousseau's lack of safe spaces and a threat actively hunting the party means it particularly indulges in taking the life of its inhabitants. To that end, a few house rules regarding character creation and running the game are recommended:

- Using the **Starting Equipment at Higher Levels** guidance from the _SRD_, allow each party member to start with 500 GP + 1d10 × 25 GP and a Common and Uncommon magic item of their choice, in addition to their normal starting equipment.
  - Any gold in a player's starting equipment can be spent before the adventure on additional equipment if desired.
  - In order to simplify spellcasting, spells that consume Material components of value are satisfied by consuming an equivalent amount of gold.
- Attuning to items works as normal, but Attunement takes 1 minute instead of requiring a Short Rest.

If a player character dies, the character immediately returns as a spirit. They regain all spell slots, and their other features are restored as if they completed a Long Rest, with the following changes:

- Their Hit Point Maximum is halved.
- Their creature type changes to Undead.
- When Goren attempts to find or attack a spirit, they are considered to be in a Heavily Obscured area, as he has difficulty perceiving spirits.
- If a spirit is reduced to 0 Hit Points again, they are destroyed and cannot be restored to life short of divine intervention, the _Wish_ spell, or similarly powerful features.

If the party succeeds in escaping Chateau Rousseau or defeating Goren, a player's spirit comes back to life and leaves with the rest of the party, unless the spirit were destroyed.
...
- They were sent here by Lynistad Rousseau, a powerful mage and Anni's mother.
...
As she discusses the situation, people might pick up on cues suggesting the real rationale for bringing them here. When pressed, with high Influence checks, or as accidental asides, Anni will reveal more information:
...
- The party was brought here as food for Goren. "Goren gets so lonely," she repeats, "and always so hungry..."
...
If they ask how to escape the house, Anni laughs and explains "the front door's downstairs, but only Mother knows how to open it and I haven't seen her in ages. Neta says she found out how to open the door but she refuses to tell me, what a tease. Maybe you could ask her, but she'll want something in return for it. She's always looking for new books in the library downstairs."

If they ask for any directions in the house, she happily tells them where a given room or Rousseau ghost is, but adds: "Mother's put a clever enchantment on the doors; they like to change places when no one's looking. You can try to get there, but the doors don't always go to the right places. It doesn't bother me since I can just go through the walls, and Goren's gotten used to it and is pretty good at finding his way around. Ulvaeus found something that's supposed to help keep the doors still; maybe he'll play you for it, he loves billiards. That table's set up in the game room downstairs."

If after all this, the party asks Anni to help them complete these tasks or navigate, she'll smile and shout: "Sure! Follow me!" Without hesitation, Anni phases through the floor and disappears, giggling down at the third floor, and leaving the party to their own devices.
...
This can easily cause party members to become separated if they are not careful. Doors softly close within a minute of being opened, unless held open by a creature or object.
...
The ghosts are unaffected by this room randomization as they can bypass the doors and phase through the walls. Additionally, a creature Attuned to the Mariner's Bow and looking through its scope is able to open a door to its correct room, allowing the party to enter the room normally. Otherwise, all doors, walls, ceilings, and floors are magically protected and strengthened such that creatures are unable to destroy them or magically pass through them. Any windows facing outside of the house cannot be opened or broken.
...
This hallway connects the children's room and the stairwell. The floor is covered with a dull gray carpet.

#### Children's Room (R1)

This is the room where the party awakens within the mansion and meets Anni. Small windows to the east and west reveal that the house is adrift in a swirling green and purple miasma. There is a single door leading to a small hallway.

### F3

#### F3 Hallway

This hallways connects all the F3 rooms and stairwells. The floor is covered with a deep burgundy carpet. A portrait on the wall portrays Lynistad and her children, but Goren's face is torn by claw marks, obscuring his appearance.
...
Two small dingy beds stained with blood can be found here, along with a small box of personal effects amongst the old clothing (roll three times on the Trinkets table in the _SRD_).

### F2

#### F2 Hallway

This hallway connects all the F2 rooms and stairwells. The floor is covered with a forest green carpet speckled in some places with drops of dried blood. Claw marks have been dragged across both walls leading down the halls.
...
A single bed and nightstand are the only furniture in this sparse room. An **Imp** is hiding under the bed; if disturbed, the Imp will consume a _Potion of Speed_ it found in the nightstand, attack the party, then dart out of the room to hide elsewhere. The nightstand has an additional _Potion of Speed_ in its drawer.
...
As a Reaction when you roll a d6, you can immediately reroll it, and you must use the new roll. If the new roll lands on a 1, the _Diviner's Die_ collapses into a singularity and is destroyed.

#### Emerald Signet
_Ring, rare (requires attunement)_

This silver ring is inset with an emerald which displays the Rousseau family seal in platinum lining on its surface. Spells you cast that restore Hit Points to a creature add 1d6 to the total Hit Points gained, and you can cast the _Spare the Dying_ cantrip.

Additionally, the ring has 3 charges. You can cast any of the following spells through the ring by expending one or more of the ring's charges. The ring regains all its charges at dawn.
...
**Curse.** The first time you expend one of the _Emerald Signet_'s charges, the ring glows brightly and infuses you with wild Necromancy magic, subjecting you to a minor curse. While you are Cursed by the _Emerald Signet_, you cannot remove the ring by any means, and every time an ally within 30 feet of you takes damage, that damage is split evenly between you and the ally before applying Resistance or Immunity. Damage you take in this manner cannot be reduced. The curse ends at dawn.

#### Mariner's Bow
_Weapon (shortbow), uncommon (requires attunement)_
...
Additionally, while looking through the bow's lenses, you can see Invisible creatures and objects, you can see creatures in Darkness or behind Total Cover, and targets of the _Mariner's Bow_'s attacks do not benefit from Partial Cover.

#### Ruby Signet
_Ring, rare (requires attunement)_

This gold ring is inset with a ruby which displays the Rousseau family seal in platinum lining on its surface. You gain +1 to all your melee attack rolls, your Armor Class, and all your saving throws made to end the Grappled condition.
...
**Curse.** After you expend all of the _Ruby Signet_'s charges, the ring glows brightly and infuses you with wild Conjuration magic, subjecting you to a minor curse. While you are Cursed by the _Ruby Signet_, you cannot remove the ring by any means, and each time an ally within 30 feet of you is hit by an attack you can see, you teleport and switch places with the ally automatically (no Reaction or charge required), the triggering attack automatically hits you, and you take an additional 1d4 Necrotic damage. The curse ends at dawn.

#### Sapphire Signet
_Ring, rare (requires attunement)_

This ring is carved from animal bone and is inset with a sapphire which displays the Rousseau family seal in platinum lining on its surface. You have Advantage on Constitution saving throws made to maintain Concentration, and your fingernails extend into claws, allowing your Unarmed Strike attacks to deal 1d6 Slashing damage in place of the normal Bludgeoning damage.

Additionally, you can cast the _Polymorph_ spell through the ring targeting yourself. While shape-shifted by the _Sapphire Signet_, each of your attacks can deal its normal damage type or Force damage (you make this choice each time you hit with those attacks), but when selecting a target for an attack, you must first succeed on a DC 5 Intelligence saving throw, or your target is selected at random from all viable creatures in range as your bestial instincts temporarily take over.

Once you have cast _Polymorph_ using the ring, you can't do so again until the next dawn.

**Curse.** After the _Polymorph_ spell is cast using the _Sapphire Signet_, the ring glows brightly and infuses you with wild Transmutation magic, subjecting you to a minor curse. While you are Cursed by the _Sapphire Signet_, you cannot remove the ring by any means, and whenever you take damage, you must succeed on a DC 10 Wisdom saving throw or you are shape-shifted into a sheep for 1 minute. You can repeat this saving throw at the end of each of your turns, ending the shape-shifting on a successful save. The curse ends at dawn.
...
**Annifried Rousseau** (she/her) is the eldest Rousseau who currently haunts the House with her ghost siblings.
...
**Ulvaeus Rousseau** (he/they) is the second-born child of the Rousseau family and comes off as a competitive jock.

#### Behavior

Ulvaeus has a competitive streak, and is always looking for new challengers. They can be found in the game room (**R5**) playing billiards.

If the party asks them for help, they offer a valuable prize: the _[Mariner's Bow](#mariners-bow)_, which will allow the party to navigate Chateau Rousseau without succumbing to its random maze of doors. In exchange, one person must defeat Ulvaeus in a game of billiards, and agree to sacrifice some of their life force if they lose; this sacrifice subjects the individual to a minor curse which reduces their Hit Point Maximum by 1d6 Hit Points. This reduction remains until the curse is removed.

The billiards game is accomplished by a simple series of contested Dexterity or Intelligence checks. The player chooses which ability score is used by both contestants, and can change this choice each time. The first challenger to win five contests is the winner of the game. Players can also come up with alternative methods, such as attempting to cheat with Dexterity (Sleight of Hand) checks (Ulvaeus will never cheat), or their friends can assist with magic.
...
|         |    | MOD | SAVE |         |    | MOD | SAVE |
|:-------:|:--:|:---:|:----:|:-------:|:--:|:---:|:----:|
| **STR** | 16 | +3  | +3   | **INT** | 11 | +1  | +1   |
| **DEX** | 17 | +3  | +5   | **WIS** | 10 | +0  | +0   |
| **CON** | 12 | +1  | +1   | **CHA** | 15 | +2  | +2   |

- **Skills:** Acrobatics +5, Persuasion +4
- **Resistances:** Acid, Cold, Fire, Lightning, Thunder; Bludgeoning, Piercing, and Slashing from attacks that aren't silvered
...
_**Rapier.**_ _Melee Weapon Attack:_ +5 to hit, reach 5 ft. _Hit:_ 7 (1d8 + 3) Piercing damage.

_**Telekinetic Thrust.**_ Ulvaeus targets a creature or unattended object within 30 feet of them. An object targeted by this effect cannot weigh more than 150 pounds.

If the target is a creature, it must succeed on a DC 13 Strength saving throw, or it is hurled up to 30 feet in any direction horizontal to Ulvaeus. If the hurled creature comes into contact with a hard surface or heavy object, the target takes Bludegeoning damage as if it fell the distance moved.
...
**Neta Rousseau** (she/her) is the second-youngest Rousseau. She enjoys reading and is always looking for new books, but at this point she's gone through everything in the House that she can find.
...
If the party has no books to offer, she will gladly take some life force from one volunteer in exchange. This sacrifice subjects the individual to a minor curse which reduces their Hit Point Maximum by 1d6 Hit Points. This reduction remains until the curse is removed.

Like Ulvaeus, Neta also is happy to challenge the party to friendly combat for the information. If the party agrees or attempts to attack Neta, the fireplace surges as multiple **Magma Mephits** leaps out (one for every two party members, rounded up). Neta will let her creations fight for her but will defend herself if attacked.
...
- **Skills:** Arcana +5, Investigation +5, Perception +3
- **Resistances:** Acid, Cold, Fire, Lightning, Thunder; Bludgeoning, Piercing, and Slashing from attacks that aren't silvered
- **Immunities:** Exhausted, Grappled, Necrotic, Paralyzed, Petrified, Poison, Prone, Restrained, Unconscious
...
- At Will: _Chill Touch_, _Prestidigitation_
- 3/Day Each: _Detect Magic_, _Dissonant Whispers, _Hideous Laughter_, _Sleep_
- 1/Day Each: _Blindness/Deafness_, _Ray of Enfeeblement_

#### Actions

_**Paralyzing Touch.**_ _Melee Spell Attack:_ +4 to hit, reach 5 ft. _Hit:_ 3 (1d6) Cold damage, and the target must succeed on a DC 13 Constitution saving throw or it has the Paralyzed condition for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

_**Reading Material (Recharge 6).**_ Neta creates a swirling storm of flying books in a 10-foot Emanation for 1 minute. A creature that starts its turn in the Emanation or enters the area must succeed on a DC 13 Dexterity saving throw or it takes 7 (2d6) Bludgeoning dmaage and has the Prone condition. A creature only makes this save once per turn.

### Goren Rousseau

#### Description

The youngest of the Rousseau children, **Goren Rousseau** (he/him) was corrupted by an entity from the Far Realm. This mutation cursed him with an insatiable desire to consume the life force of other creatures, including his own siblings. He now roams the house, ashamed of his terrible actions but forever compelled to feed again.
...
|         |    | MOD | SAVE |         |    | MOD | SAVE |
|:-------:|:--:|:---:|:----:|:-------:|:--:|:---:|:----:|
| **STR** | 18 | +4  | +7   | **INT** | 9  | -1  | -1   |
| **DEX** | 15 | +2  | +2   | **WIS** | 14 | +2  | +2   |
| **CON** | 20 | +5  | +8   | **CHA** | 15 | +2  | +2   |

- **Skills:** Athletics +7, Intimidation +5, Pereption +5
- **Resistances:** Bludgeoning, Cold, Piercing, Slashing
- **Immunities** Frightened, Psychic
- **Senses:** Darkvision 60 ft. (unimpeded by magical Darkness), Passive Perception 15
- **Languages:** Common, Deep Speech, Elvish
- **CR:** 5 (1,800 XP; PB +3)

#### Traits

_**Negative Self-Image.**_ When Goren can see his own visage, he shields his eyes, giving himself the Blinded condition. He then spends all his actions either trying to flee or trying to cover or destroy the reflection, at which point he ends the Blinded condition.
...
_**Multiattack.**_ Goren makes three attacks: one with his Bite, and two with his Claws.

_**Bite.**_ _Melee Weapon Attack:_ +7 to hit, reach 5 ft. _Hit:_ 11 (2d6 + 4) Piercing damage, and the creature must make a DC 13 Constitution saving throw. On a failed save, the creature's Hit Point Maximum is reduced by the amount of damage taken from Goren's bite, Goren regains that number of Hit Points, and the creature has the Frightened condition for 1 minute. The creature can make a DC 13 Wisdom saving throw at the end of each of its turns, ending the Frightened condition on a success.

_**Claws.**_ _Melee Weapon Attack:_ +7 to hit, reach 5 ft. _Hit:_ 8 (1d8 + 4) Slashing damage.

_**Gravity Well (3/Day).**_ Goren redirects gravity in a 60-foot Cone. Any creature or object within the Cone must make a DC 15 Dexterity saving throw. On a failed save, a target has the Prone condition and is dragged up to 30 feet toward Goren, and if this movement brings a creature within Goren's reach, he can attack one such creature with his Claws as part of this action. On a successful save, a target lands Prone as it drops down and grabs the ground to hold its position.
